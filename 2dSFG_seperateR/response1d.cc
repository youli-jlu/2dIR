...
//cumulant1d method
cumulant1d::cumulant1d(para parameterin,transition transin1)
  :response1d(parameterin,transin1) {} ;

double cumulant1d::gamma(int t1) { return exp(-gamma1*t1);}
double* cumulant1d::correlation_function(string filename,transition transin1,transition transin2)
{
  int tk;
  double *g;
